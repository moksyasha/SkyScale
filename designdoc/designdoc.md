...
- [Введение](#введение)
    ...
    - [Цели](#цели)
    - [Ограничения на модель](#ограничения-на-модель)
    - [Источники Данных](#источники-данных)
    - [Форматы Данных](#форматы-данных)
- [Используемые модели, системные требования](#используемые-модели-системные-требования)
    - [Выбор Алгоритмов](#выбор-алгоритмов)
    - [Системные Требования](#системные-требования)
    - [Хранение Данных](#хранение-данных)
- [Этапы разработки и план](#этапы-разработки-и-план)
