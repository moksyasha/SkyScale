...
# basic vsr with new optical flow model
...
class DeformableAlignment(nn.Module):
    def __init__(self, input_channels=128, out_channels=64, kernel=3,
        ...
        self.kernel = kernel
        # convolution for current feat and reference (feat_propagated, prev_featur, flow1, flow2)
...
class MoksPlus(nn.Module):
    ...
    def upsample(self, lr, feats):
        ...
        Args:
            lqs : low quality (LQ) sequence with shape (n, t, c, h, w).
            feats (dict): features from the propagation branches.
    ...
    def propagate(self, feats, flows, module_name):
        """Propagate the  features through the sequence.
        """
